...
public class ScreenManager {
    ...
    /**
     * Returns a list of compatible display modes for the default system device.
    ...
    */
    ...
    public void setFullScreen(DisplayMode mode) {
        ...
        if(mode != null && device.isFullScreenSupported()) {
            try {
                device.setDisplayMode(mode);
            } catch(IllegalArgumentException ex) {
                System.out.println("IllegalArgumentException catched: "+ex.getMessage());
            }
        }
     ...
     * @return Graphics context for the display.
     */
